      ...
      <!-- Modal content-->
        <div class="modal-content">
          ...
          <div class="form-group">
                ...
                <table>
                  <tr>
                    <td><img src="" id="img2" class="image2" style="height: 160px; width: 140px; background-color: #ccc; border: 2px solid gray;">
          ...
          <div class="form-group">
                ...
                <table>
                  <tr>
                    <td><img src="" id="img3" class="image3" style="height: 160px; width: 140px; background-color: #ccc; border: 2px solid gray;">
                      <input type="file" name="image3" id="photo3" style="display: none;">
                        <input type="hidden"  name="old_logo3" class="image3">
                    </td>
                  </tr>
                  <tr>
                    <td><input type="button" name="" value="Browse" id="klikfoto3" class="btn-success form-control"></td>
                  </tr>
                </table>
              </div>
                        <div class="form-group">
           ...
           <header class="header-desktop">
            ...
            <div class="col-lg-8">
                                <div class="card">
                                    ...
                                    <form class="horizontal" action="{{ route('barang.store') }}" method="post"  enctype="multipart/form-data">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="material"  rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        @if (!empty($data))
                                            ...
                                            <tr>
                                                ...
                                                <td><img src="{{ url('img') }}/{{ $tabel->image1 }}" width="400" alt=""></td>
                                                <td>{{$tabel->deskripsi}}</td>
                                                <td>{{$tabel->material}}</td>
                                                <td>
                                                <button class="btn btn-danger fas fa-exclamation-triangle btn-apus" value="{{$tabel->id_barang}}">Hapus</button></td>
                                                <td><button class="btn btn-success far fa-edit btn-sm btn-ubah" nama_barang="{{$tabel->nama_barang}}" kategori="{{$tabel->kategori}}" 
                                                                                                                harga_barang="{{$tabel->harga_barang}}" jumlah="{{$tabel->jumlah}}"
                                                                                                                image1="{{$tabel->image1}}" image2="{{$tabel->image2}}" image3="{{$tabel->image3}}"
                                                                                                                deskripsi="{{$tabel->deskripsi}}" material="{{$tabel->material}}" idx="{{$tabel->id_barang}}" >Edit</button></td>
